/*Write a Program to accept the age of the user and then, display the category of the
   user. Based on the age, the categories of the users are:
	...
	System.out.println(" person is Teenagers");
	else if(age>=20 && age<=35)
	System.out.println(" person is Young adults");
	else if(age>=36 && age<=45)
	System.out.println(" person is Mature adults");
	else if(age>=46 && age<=55)
	System.out.println(" person is Elders");
	else if(age>=56 && age<=100)
	System.out.println(" person is Seniors");
	}
	}