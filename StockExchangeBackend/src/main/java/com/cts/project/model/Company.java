...
public class Company implements Serializable{
	...
	private static final long serialVersionUID = 8997261364896312075L;
@Id	
...
public String toString() {
	return "Company [idNumber=" + idNumber + ", companyName=" + companyName + ", ceoName=" + ceoName + ", boardMember="
			+ boardMember + ", turnOver=" + turnOver + ", briefDescription=" + briefDescription + ", ipoDate=" + ipoDate
			+ "]";
}
